...
public final class LsSimulator extends ComponentDefinition {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LsSimulator.class);
...
//-------------------------------------------------------------------	
    Handler<LsSimulatorInit> handleInit = new Handler<LsSimulatorInit>() {

        @Override
        public void handle(LsSimulatorInit init) {
            System.out.println("Live Streaming Simulator Init");
            System.out.println("- - - - - - - - - - - - - - - -");
            ...
            System.out.println("Number parents: " + parentMakerConfiguration.getNumParents());
...
//-------------------------------------------------------------------	
    private Component createAndStartNewPeer(Integer id, VodAddress.NatType natType) {
        ...
        trigger(new NatTraverserInit(self.clone(VodConfig.SYSTEM_OVERLAY_ID),
                ...
                RendezvousServerConfiguration.build().setSessionExpirationTime(30 * 1000),
        ...
        trigger(new InterAsInit(self.clone(VodConfig.SYSTEM_OVERLAY_ID),
