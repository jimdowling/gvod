...
function generate_page() 
{
    ...
    if (platf.browserName == "Firefox")
    {
        if (platf.browserVersion >= 3.5)
        {
	        ...
	        {
		         downloadurl = "download/Gvod_2.0.0w14-mac.xpi";
	        ...
	        else if (platf.osName == "Windows" || platf.osName == "Linux")
            {
                 ...
                 if (platf.osName == "Linux")
                 {
                	 ...
                	 downloadurl = "download/Gvod_2.0.0w14-linux.xpi";
                 }
                 else if (platf.osName == "Windows")
                 {
                     downloadurl = "download/Gvod_2.0.0w14-win32.xpi";
                 }
                 ...
                 {
            		 inst += '<ol start=5>';
            		 inst += '<li> Use your package manager to install the software required to run Gvod:';
            		 inst += '<ul>';
            ...
            {
                 // .deb version
                 downloadurl = "download/Gvod_2.0.0-1ubuntu14_all.deb";
                 
                 
                 inst += '<ol>';
                 inst += '<li> Click "OK" to open the Gvod deb file with the GDebi Package Installer.';
        		 inst += '</ol>';
    ...
    {
        document.write("<p><strong>Unfortunately, Gvod is not (yet) available for your platform.</strong></p>");
    }
