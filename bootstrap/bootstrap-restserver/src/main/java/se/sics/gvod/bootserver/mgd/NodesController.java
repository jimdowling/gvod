...
import se.sics.gvod.bootserver.session.NodesFacade;
...
@ManagedBean(name = "nodesController")
@SessionScoped
public class NodesController implements Serializable {
    ...
    @EJB
    private se.sics.gvod.bootserver.session.NodesFacade ejbFacade;
    ...
    public static class NodesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Nodes) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + NodesController.class.getName());
            }
        }
    }
}
